function [mix, errlog, options, cvgcause] = gmminit(mix, x, options)
...
options(5) = 1;	 % Centres and posteriors will be initialised from data
[mix.centres, options, post, errlog, cvgcause] = netkmeans(mix.centres, x, options);
